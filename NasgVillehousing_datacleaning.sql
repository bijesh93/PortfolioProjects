...
--Taking address only form the Property address table
SELECT
...
--Creating a new column and adding the a column with Property address only
ALTER TABLE DataCleaning.dbo.NashvilleHousing
...
--Creating a new column and adding the a column with Property city address only
ALTER TABLE DataCleaning.dbo.NashvilleHousing
...
--Looking at the results from queries
